...
<header id="header" class="fixed-top">
  <div class="container d-flex align-items-center justify-content-lg-between">
      @foreach ($Home as $h)
      <h1 class="logo me-auto me-lg-0"><a href="">{{ $h->title_1 }}</a></h1>
      @endforeach
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="my-3">
                ...
                <div class="error-message">Kenapa tuh kira-kira</div>
                <div class="sent-message">Pesanmu sudah terkirim. Thank you!</div>
              </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <p>Informasi Seputar PASTALIA</p>
